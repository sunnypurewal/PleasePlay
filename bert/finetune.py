...
def main():
    ...
    print("Loading custom BIO datasets...")
    
    dataset_dirs = ["data/dataset1", "data/dataset2", "data/dataset3", "data/dataset4"]
    ...
    for dataset_dir in dataset_dirs:
        train_path = f"{dataset_dir}/train.bio"
        test_path = f"{dataset_dir}/test.bio"
